...
public class PayloadWriter {
     ...
     * @throws IOException
     */
    public static void writeValues(final File apkFile, final Map<Integer, ByteBuffer> idValues, final boolean lowMemory) throws IOException {
    ...
    static void writeApkSigningBlock(final File apkFile, final ApkSigningBlockHandler handler, final boolean lowMemory) throws IOException {
        ...
        try {
            ...
            if (apkSigningBlockOffset != 0 && centralDirStartOffset != 0) {
                ...
                final long length = apkSigningBlock.writeTo(fIn);
